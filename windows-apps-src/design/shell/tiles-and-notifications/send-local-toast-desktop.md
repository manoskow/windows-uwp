...
ms.date: 01/23/2018
ms.topic: article
keywords: windows 10, uwp, win32, desktop, toast notifications, send a toast, send local toast, desktop bridge, C#, c sharp, toast notification, wpf
...
If you haven't enabled the Windows 10 SDK for your Win32 app, you must do that first. Simply install the [Windows SDK NuGet](https://www.nuget.org/packages/Microsoft.Windows.SDK.Contracts/) package; you can read more about NuGet, tooling, and creating or consuming packages on the [public documentation](https://docs.microsoft.com/en-us/nuget/what-is-nuget).


## Step 2: Install the compat library code

The compat library abstracts much of the complexity of desktop notifications. The following instructions require the compat library. Install the [Windows Community Toolkit Desktop Notifications]() library in your project.
...
* [NuGet Documentation](https://docs.microsoft.com/en-us/nuget/what-is-nuget)
